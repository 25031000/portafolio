    ...
    return (
        <li className="p-2 flex justify-around items-center">
            <div className=" py-4 md:w-1/2 grid place-content-center">
                <div className="flex">
                    <img className="pt-[3px] mx-auto md:w-[60px] w-12 h-48 md:h-[60px]" src="html.webp" alt="" />
                    <img className="mx-auto w-[72px] h-[60px]" src="css.webp" alt="" />
                </div>
...
export function ListItemThree() {
    return (
        <li className="p-2 flex justify-around items-center">
            <div className=" py-4 md:w-1/2 grid place-content-center">
                <div className="flex">
                    <img className="pt-[3px] mx-auto w-16 h-48 " src="sq.svg" alt="" />
                </div>
                <p className="text-center py-4 text-base md:text-xl">Sqlite</p>
            </div>
            <div className=" py-4 md:w-1/2 grid place-content-center">
